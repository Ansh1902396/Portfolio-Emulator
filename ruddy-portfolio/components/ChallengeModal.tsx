...
export function ChallengeModal({ challenge, onSolve, onClose }: ChallengeModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (input.trim()) {
      ...
      setInput('');
      setFeedback(result[0].includes("Correct") ? "Correct!" : "Incorrect. Try again.");
    }
  };
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex items-center">
              ...
              />
              <button type="submit" className="ml-2 px-4 py-2 bg-green-500 text-black rounded hover:bg-green-600 focus:outline-none">
                Submit
              </button>
            </form>
            {feedback && (
